...
public class MainGUI{
        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(customerText.getText().equals(noText)){
                    JOptionPane.showMessageDialog(null, "Introduceti un nume pentru a accesa configuratorul", "Greseala", JOptionPane.ERROR_MESSAGE);
                }
                else if(!(breadButton1.isSelected() || breadButton2.isSelected()|| breadButton3.isSelected() || breadButton4.isSelected())){
                    JOptionPane.showMessageDialog(null, "Selectati serviciul gratis", "Greseala", JOptionPane.ERROR_MESSAGE);
                }
                else{
                    JFrame display = new JFrame("Confirmare");
                    display.setContentPane(new ConfirmGUI(dealer, customerText.getText(), Double.parseDouble(dealer.getPrice().replace(",","."))).getMasterPanel());
                ...
                if (Arrays.equals(actualField, comboBox.getName().split("ComboBox"))){
                    radioButton.addItemListener(new ItemListener() {
                        ...
                        public void itemStateChanged(ItemEvent e) {
                            String name = radioButton.getText().split( " - EUR ")[0];
                            String value = radioButton.getText().split( " - EUR ")[1];
                            if(comboBox.isEnabled()){
                              /*  comboBox.setEnabled(false);*/
                                dealer.updateIngredients(name, value, Integer.parseInt(comboBox.getSelectedItem().toString()), false);
                                updatePrice();
                            }else{
                                comboBox.setEnabled(true);
                                dealer.updateIngredients(name, value, Integer.parseInt(comboBox.getSelectedItem().toString()), true);
                                updatePrice();
                            }
                        }
                        private ItemListener setParams(JComboBox comboBox, Dealer dealer, JRadioButton radioButton) {
                            this.comboBox = comboBox;
                            this.dealer = dealer;
                            this.radioButton = radioButton;
                            return this;
                        }
                    }.setParams(comboBox, dealer, radioButton));
                }
            }
        }
    }
            ...
            for(JComboBox comboBox:comboBoxes){
                ...
                if (Arrays.equals(actualField, comboBox.getName().split("ComboBox"))){
                    checkBox.addActionListener(new ActionListener() {
                        ...
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            String name = checkBox.getText().split( " - EUR ")[0];
                            String value = checkBox.getText().split( " - EUR ")[1];
                            if(comboBox.isEnabled()){
                                comboBox.setEnabled(false);
                                dealer.updateIngredients(name, value, Integer.parseInt(comboBox.getSelectedItem().toString()), false);
                                updatePrice();
                        ...
                        private ActionListener setParams(JComboBox comboBox, Dealer dealer, JCheckBox checkBox){
                            this.comboBox = comboBox;
                            this.dealer = dealer;
                            this.checkBox = checkBox;
                            return this;
                        }
                    }.setParams(comboBox, dealer, checkBox));
                }
            }
        }
    }
    ...
    private void comboActionReceiver(JComboBox comboBox, JRadioButton radioButton){
        comboBox.addActionListener(new ActionListener() {
            ...
            private ActionListener setParams(JComboBox comboBox, Dealer dealer, JRadioButton radioButton){
                this.comboBox = comboBox;
                this.dealer = dealer;
                this.radioButton = radioButton;
                return this;
    ...
    private void updatePrice(){
        ...
        totalValueLabel.setText("EUR "+ dealer.getPrice());
    }
